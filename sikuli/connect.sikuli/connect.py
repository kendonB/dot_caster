...
def export_kupe():
    ...
    sleep(0.5)
    type("kupe")
    wait("1554854984864.png" or "1554855009038.png" or "1559677060086.png", 20)
    hover("1554854984864.png" or "1554855009038.png" or "1559677060086.png")
